...
# Report System Class 
class ReportSystem:
    def __init__(self, report_id, name, location, concern, severity):
    ...
    def update_status(self, new_status) -> str:
        if new_status in (ReportStatus.SUBMITTED, ReportStatus.REVIEWED, ReportStatus.ASSIGNED, ReportStatus.PENDING, ReportStatus.IN_PROGRESS, ReportStatus.RESOLVED, 
